...
<head>
    ...
    <title>[Dataworld Support] New Ticket: {{ $ticket->ticket_number }}</title>
    <style>
        body, table, td, p, a {
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; border-collapse: collapse; margin: 0 auto;" align="center">
                    ...
                    <tr>
                        <td align="left" style="padding: 20px 0;">
                            ...
                            <!-- Priority, Category, Created - EXACT placement as your image -->
                            ...
                            <div style="background-color: #f0f9ff; border: 1px solid #bae6fd; border-radius: 8px; padding: 15px; margin: 20px 0;">
                                <strong style="color: #0369a1; display: block; margin-bottom: 10px;">📎 Attachments ({{ count(json_decode($ticket->attachments, true)) }})</strong>
                           ...
                           <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 30px 0 20px;" align="center">
                                <tr>
                                    <td align="center">
                                        <!-- View All Tickets Button - Improved -->
                                ...
                                <tr>
                                    <td align="center" style="color: #6b7280; font-size: 12px;">
                                        ...
                                        <p style="margin: 5px 0;">
                                            ...
                                            <a href="{{ route('profile.dashboard') }}" style="color: #667eea; text-decoration: none; margin: 0 5px;">Dashboard</a> |
                                            <a href="mailto:{{ $supportEmail }}" style="color: #667eea; text-decoration: none; margin: 0 5px;">Contact Support</a>
                                        </p>
