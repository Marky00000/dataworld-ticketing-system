    ...
    <main class="flex-1">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-gray-100">
                <!-- Step Indicator -->
                <!-- Step Indicator - Ultra Compact for Mobile -->
<div class="step-indicator flex justify-between items-center mb-6 relative">
    ...
    <!-- Step 1 -->
    <div class="step active relative z-10 flex items-center justify-center w-10 h-10 sm:w-auto sm:h-auto sm:px-6 sm:py-3 bg-white rounded-full shadow-sm border-2 border-primary text-primary font-medium" data-step="1">
        <span class="step-number w-6 h-6 flex items-center justify-center bg-primary text-white rounded-full text-xs">1</span>
        <span class="hidden sm:inline ml-2">Ticket Details</span>
    </div>
    
    <!-- Step 2 -->
    <div class="step relative z-10 flex items-center justify-center w-10 h-10 sm:w-auto sm:h-auto sm:px-6 sm:py-3 bg-white rounded-full shadow-sm border-2 border-gray-300 text-gray-500 font-medium" data-step="2">
        <span class="step-number w-6 h-6 flex items-center justify-center bg-gray-300 text-white rounded-full text-xs">2</span>
        <span class="hidden sm:inline ml-2">Device Info</span>
    </div>
    
    <!-- Step 3 -->
    <div class="step relative z-10 flex items-center justify-center w-10 h-10 sm:w-auto sm:h-auto sm:px-6 sm:py-3 bg-white rounded-full shadow-sm border-2 border-gray-300 text-gray-500 font-medium" data-step="3">
        <span class="step-number w-6 h-6 flex items-center justify-center bg-gray-300 text-white rounded-full text-xs">3</span>
        <span class="hidden sm:inline ml-2">Review & Submit</span>
    </div>
</div>
                ...
                <form action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data" id="ticketForm">
                    ...
                    <div class="form-step active-step" id="step1">
                        <!-- YOUR EXISTING STEP 1 CONTENT - KEEP AS IS -->
                        <div class="space-y-6">
                            <!-- Subject -->
                            <div>
                    ...
                    <div class="form-step" id="step2">
                        <!-- YOUR EXISTING STEP 2 CONTENT - KEEP AS IS -->
                    ...
                    <div class="form-step" id="step3">
                        <!-- YOUR EXISTING STEP 3 CONTENT - KEEP AS IS -->
                        <div class="space-y-6">
                            <!-- Contact Information -->
